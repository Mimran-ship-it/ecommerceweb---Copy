...
console.log(globaldata.datareq)
    return (  
      <motion.div
        initial={{ opacity: 0, x:200   }}  animate={{ x : 0, opacity: 1, scale: 1}} transition={{ delay: 0.6,duration:.4,stiffness: 70,type:'spring' }}>
        <section className="text-gray-600 body-font lg:ms-36">
    <div  className="container px-5 py-24 mx-auto">
      <div className="flex flex-wrap -m-4">
           {key.map((ele)=>{          
             return globaldata.datareq[ele].category=='Pants' && 
  ...
  transition: {
    duration: .2
          ...
          <Link className="block relative rounded overflow-hidden cursor-pointer h-3/6" href={'/Pants/'+ globaldata.datareq[ele].slug}> 
