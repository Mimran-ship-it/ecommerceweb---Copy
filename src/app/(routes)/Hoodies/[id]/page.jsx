              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                  ...
                  {Object.keys(fetchdata.datareq[ele].size).map((size) => {
                      ...
                      {fetchdata.datareq[ele].size[size].map((color)=>{return <button  key={Math.random()} value={color} className= 'border px-1 rounded-lg shadow-2xl hover:bg-slate-300 ml-1 border-black' onClick={(e) => {  setImage(fetchdata.datareq[ele].image[e.target.value]); setcolor(e.target.value)
